...
# This block of code is for submission.py to run
s = RoverState()
# These conditions force the search to solve a specific sub problem
# This is done by eliminating all the work to do except for one
s_move_sample_goal = RoverState()
...
print("--------------------------------------------")
print("Move To Sample Goal Breadth")
breadth_first_search(s_move_sample_goal, action_list, mission_complete, subproblem = "move_to_sample")
print("--------------------------------------------")
print("Remove Sample Goal Breadth")
breadth_first_search(s_remove_sample_goal, action_list, mission_complete, subproblem = "remove_sample")
print("--------------------------------------------")
print("Move To Battery Goal Breadth")
breadth_first_search(s_return_charger_goal, action_list, mission_complete, subproblem = "return_to_charger")
print("--------------------------------------------")
...
print("--------------------------------------------")
print("Move To Sample Goal Depth")
depth_first_search(s_move_sample_goal, action_list, mission_complete, subproblem = "move_to_sample")
print("--------------------------------------------")
print("Remove Sample Goal Depth")
depth_first_search(s_remove_sample_goal, action_list, mission_complete, subproblem = "remove_sample")
print("--------------------------------------------")
print("Move To Battery Goal Depth")
depth_first_search(s_return_charger_goal, action_list, mission_complete, subproblem = "return_to_charger")
print("--------------------------------------------")
print("-------DFS VS DLS-------")
print("--------------------------------------------")
print("-----DFS-----")
depth_first_search(s, action_list, mission_complete)
print("-----DLS-----")
depth_first_search(s, action_list, mission_complete, limit = 10)
print("")
